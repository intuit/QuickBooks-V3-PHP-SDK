...
// Add Recurring Transaction for Invoice Entity
$theResourceObj = Invoice::create([
   ...
   [
    ...
    "RecurringInfo" => [
        ...
        "Name" => "RecurTemplate71"
    ]
]);

$resultingObj = $dataService->addRecurringTxn($theResourceObj);
...
if ($error) {
    ...
    echo "Recurring Transaction Created: Below is the Raw Response \n\n";
    ...
    echo "Recurring Transaction Created: Below is the XML Response \n\n";
    echo $xmlBody . "\n";
}

/*
Recurring Transaction Created: Below is the XML Response
