...
if (!defined('POPO_CLASS_PATH')) {
    define('POPO_CLASS_PATH', $sdkDir . 'src' . DIRECTORY_SEPARATOR . 'Data' . DIRECTORY_SEPARATOR);
}

\Console::Log('POPO_CLASS_PATH', POPO_CLASS_PATH);
...
require_once(PATH_SDK_ROOT . 'src/XSD2PHP/src/com/mikebevz/xsd2php/Php2Xml.php');
require_once(PATH_SDK_ROOT . 'src/XSD2PHP/src/com/mikebevz/xsd2php/Bind.php');
