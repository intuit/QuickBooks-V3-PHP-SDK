...
This page provides a quick introduction to QuickBooks Online Authorization Protocol: OAuth 1 and OAuth 2, and how to use it 
in the SDK. If you have not already installed QuickBooks V3 SDK, head over to the :ref:`installation`
page.
...
For all developer accounts registered at developer.intuit.com before **July.17th**, 2017, they will have OAuth 1 protocol default
for their app. The key page will look like this:
